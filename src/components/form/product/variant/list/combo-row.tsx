...
import type { VariantDataType, VariantType } from "@/types/product";
...
function parseValue<K extends keyof VariantType>(
	field: K,
	value: string,
): VariantType[K] {
...
export default function ComboRow({ data = {}, onChange }: CombinationRowProps) {
