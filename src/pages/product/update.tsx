...
import { DeliveryFields } from "@/components/form/product/delivery-fields";
...
export function ProductUpdatePage() {
	...
	const saveProductMutation = useMutation({
		mutationFn: async (value: FormValues) => {
			...
			const request: UpdateProductRequest = {
				...
				weight: value.deliveryGroup.weight,
				long: value.deliveryGroup.long,
				wide: value.deliveryGroup.wide,
				high: value.deliveryGroup.high,
	...
	const defaultValues: FormValues = {
		...
		deliveryGroup: {
			weight: getProductQuery.data.data.weight,
			long: getProductQuery.data.data.long,
			wide: getProductQuery.data.data.wide,
			high: getProductQuery.data.data.high,
		},
		activeGroup: {
			...
			<Card className="bg-sidebar border-0 shadow-none max-w-6xl mx-auto">
				...
				<CardContent className="grid grid-cols-12 gap-4">
					<div className="col-span-8 space-y-4">
						...
						<DeliveryFields fields="deliveryGroup" form={form} />
